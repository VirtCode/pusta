/// This module is shamelessly stolen from the serene cli.
/// See https://github.com/VirtCode/serene-aur/blob/main/cli/src/table/mod.rs
/// It is probably also not up-to-date with the serene version, but does the trick.
